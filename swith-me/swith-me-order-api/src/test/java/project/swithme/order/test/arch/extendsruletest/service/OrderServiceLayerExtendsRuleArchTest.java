package project.swithme.order.test.arch.extendsruletest.service;
...
public class OrderServiceLayerExtendsRuleArchTest {

    @ArchTest
    @Description(content = "OrderUseCase의 구현체들은 Service가 클래스 이름 끝에 붙어야 한다.")
    ArchRule orderUseCaseImplNamingRuleTest = classes().that().implement(OrderCommandUseCase.class)
        .should().haveSimpleNameEndingWith(SERVICE);

    @ArchTest
    @Description(content = "OrderQueryUseCase의 구현체들은 Service가 클래스 이름 끝에 붙어야 한다.")
