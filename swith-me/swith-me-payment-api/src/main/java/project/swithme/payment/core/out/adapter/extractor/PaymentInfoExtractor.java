package project.swithme.payment.core.out.adapter.extractor;
...
import project.swithme.payment.core.out.adapter.response.CashReceiptResponse;
import project.swithme.payment.core.out.adapter.response.CashReceiptsResponse;
import project.swithme.payment.core.out.adapter.response.DiscountResponse;
import project.swithme.payment.core.out.adapter.response.EasyPayResponse;
import project.swithme.payment.core.out.adapter.response.GiftCertificateResponse;
import project.swithme.payment.core.out.adapter.response.MobilePhoneResponse;
import project.swithme.payment.core.out.adapter.response.PaymentApproveResponse;
import project.swithme.payment.core.out.adapter.response.PaymentCardResponse;
import project.swithme.payment.core.out.adapter.response.PaymentVirtualAccountResponse;
import project.swithme.payment.core.out.adapter.response.TransferResponse;
