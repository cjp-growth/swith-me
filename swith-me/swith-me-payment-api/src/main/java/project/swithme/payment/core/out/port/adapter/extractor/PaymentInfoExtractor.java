package project.swithme.payment.core.out.port.adapter.extractor;
...
import project.swithme.payment.core.out.port.adapter.response.success.CashReceiptResponse;
import project.swithme.payment.core.out.port.adapter.response.success.CashReceiptsResponse;
import project.swithme.payment.core.out.port.adapter.response.success.DiscountResponse;
import project.swithme.payment.core.out.port.adapter.response.success.EasyPayResponse;
import project.swithme.payment.core.out.port.adapter.response.success.GiftCertificateResponse;
import project.swithme.payment.core.out.port.adapter.response.success.MobilePhoneResponse;
import project.swithme.payment.core.out.port.adapter.response.success.PaymentApproveResponse;
import project.swithme.payment.core.out.port.adapter.response.success.PaymentCardResponse;
import project.swithme.payment.core.out.port.adapter.response.success.PaymentVirtualAccountResponse;
import project.swithme.payment.core.out.port.adapter.response.success.TransferResponse;
