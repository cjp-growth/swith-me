package project.swithme.order.test.order.documentation_test.save;
...
import static project.swithme.order.test.order.documentation_test.snippet.OrderSnippet.ORDER_CREATE_REQUEST_FIELD_DESCRIPTOR;
import static project.swithme.order.test.order.documentation_test.snippet.OrderSnippet.ORDER_CREATE_RESPONSE;
